...
<dl>
	<dt>com</dt>
	<dd>Mainly for commercial entities, but unrestricted</dd>
	<dt>org</dt>
	<dd>Originally for organizations not clearly falling within the other gTLDs, now unrestricted</dd>
	<dt>edu</dt>
	<dd>Educational use, but now primarily for US third level colleges and universities</dd>
	<dt>gov</dt>
	<dd>Governmental use, but now primarily for US governmental entities and agencies</dd>
	<dt>mil</dt>
	<dd>Military use, but now primarily for US military only</dd>
</dl>
